...
- (void)asyncSubGroupList
{
    ...
    // 获取分组列表
    NSArray *list = [[TIMFriendshipProxy sharedInstance] GetFriendGroupList];
    [ws createSubGroupList:list];
//    [[IMAPlatform sharedInstance].friendShipMgr GetFriendGroups:nil succ:^(NSArray *array) {
//        [ws createSubGroupList:array];
