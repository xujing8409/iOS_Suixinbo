...
- (void)addOwnViews
{
    ...
    _image.backgroundColor = kRandomFlatColor;
...
{
    NSArray *vs = @[_image, _photo, _video, _file];
    
    
    [self alignSubviews:vs horizontallyWithPadding:kDefaultMargin margin:0 inRect:self.bounds];
}
