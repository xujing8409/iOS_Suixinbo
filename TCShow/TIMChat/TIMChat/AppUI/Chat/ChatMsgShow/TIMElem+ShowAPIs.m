...
- (Class)showCellClassOf:(IMAMsg *)msg
{
    ...
    else if (msg.type == EIMAMSG_Call)
    {
        return [ChatCallTableViewCell class];
    }
    else
    {
...
- (CGSize)sizeInWidth:(CGFloat)width atMsg:(IMAMsg *)packMsg
{
    CGSize size = [[self showDescriptionOf:packMsg] textSizeIn:CGSizeMake(width, HUGE_VAL) font:[packMsg textFont]];
