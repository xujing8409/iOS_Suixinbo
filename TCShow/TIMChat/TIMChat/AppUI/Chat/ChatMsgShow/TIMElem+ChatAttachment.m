...
- (NSArray *)chatAttachmentOf:(IMAMsg *)msg
{
    NSAttributedString *str = [[NSAttributedString alloc] initWithString:[self showDescriptionOf:msg] attributes:@{NSFontAttributeName : [msg textFont], NSForegroundColorAttributeName : [msg textColor]}];
    return @[str];
}
