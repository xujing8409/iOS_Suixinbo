...
#import "TCSoLiveMsg.h"

@implementation TCSoLiveMsg
...
{
    // do nothing
    [TCSoLiveMsg defaultShowHeightOf:self inSize:CGSizeMake(kMainScreenWidth * 0.7, HUGE_VALF)];
}
...
+ (CGSize)defaultShowSizeOf:(TCSoLiveMsg *)item inSize:(CGSize)size
{
...
{
    CGSize contentSize = [TCSoLiveMsg defaultShowSizeOf:item inSize:size];
